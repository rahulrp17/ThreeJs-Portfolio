...
const HomeInfo = ({ currentStage }) => {
  if (currentStage === 1) {
    return (
      <h1 className="sm:text-2xl sm:leading-snug   md:h-20   text-center neo-brutalism-blue  py-1 px-8 mt-10 text-white">
        HI, I'm
  ...
  if (currentStage === 2) {
    return (
      <div className="info-box mx-5 relative flex text-white flex-col  gap-3 max-w-2xl  neo-brutalism-blue pt-4 pb-8 px-8 mt-2.5 top-5">
        <p className="font-medium sm:text-xl text-center md:w-70 md:h-20">
          Entry-level full-stack developer passionate about building modern web
          apps.
        </p>
  ...
  if (currentStage === 4) {
    return (
      <div className="info-box  neo-brutalism-blue mx-5 relative flex mt-2.5   text-white flex-col gap-3 max-w-110 neo-brutalism-blue pt-4 pb-10 px-8  top-5">
        <p className="font-medium sm:text-xl text-center md:w-80 md:h-12">
